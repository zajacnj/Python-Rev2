...
if not API_KEY:
    raise ValueError("NCBI_API_KEY environment variable is not set. Please set it in your .env file.")

def author_details(pmid):
    keyword = pmid
    esearch = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term="
    # covid19&usehistory=true&webenv=true&retmax=10&api_key=REDACTED_API_KEY"
